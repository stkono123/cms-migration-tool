            ...
            <div className="card-body">
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 16 }}>
                ...
                <div ref={sourceDropdownRef} style={{ position: 'relative', marginBottom: 16 }}>
                    <button data-1p-ignore onClick={() => setSourceDropdownOpen(!sourceDropdownOpen)} style={{ width: '100%', background: '#080b12', border: '1px solid #1e293b', borderRadius: 8, padding: '10px 14px', color: '#e2e8f0', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'space-between', fontFamily: 'Inter, sans-serif', fontSize: 14, fontWeight: 600 }}>                  <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
        ...
        {allConnected && (
          <div className="fade-up" style={{ background: '#0f1623', border: '1px solid #1e293b', borderRadius: 14, padding: 20, marginBottom: 20 }}>
            ...
            <div style={{ marginTop: 10, fontSize: 12, color: '#64748b' }}>
              {modelMode === 'create'
                ? 'Produkte nach commercetools. Pages und Blogs nach Contentful. Du prüfst die Namen vor dem Anlegen.'
