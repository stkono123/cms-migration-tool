...
export function buildMappingPrompt(inventory, targets, csvTarget = 'contentful') {
...
MIGRATIONSZIEL (vom User gewählt): ${csvTarget === 'both' ? 'Beides — Daten sinnvoll auf commercetools und Contentful aufteilen' : csvTarget === 'commercetools' ? 'Nur commercetools — alle Daten als Commerce-Daten behandeln' : 'Nur Contentful — alle Daten als Content behandeln'}
...
- Halte Dich strikt an das gewählte Migrationsziel des Users
