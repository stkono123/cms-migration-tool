...
- customCss: Seitenspezifisches CSS (Symbol, optional)
- customJs: Seitenspezifisches JavaScript (Symbol, optional)
...
3. Empfohlene Feld-Typen: uid/name/label/pageStatus/customCss/customJs → Symbol; htmlEn/htmlDe/htmlFr/htmlIt/htmlEs → Text (Long text)
