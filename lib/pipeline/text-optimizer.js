...
const LEVEL_PROMPTS = {
  1: (text, tov) => `${tov}Keep the original language of the text. Do not translate. Korrigiere nur Rechtschreibung und Grammatik in folgendem Text. Ändere nichts am Inhalt, Stil oder der Struktur. Gib nur den korrigierten Text zurück, ohne Erklärungen:\n\n${text}`,
  2: (text, tov) => `${tov}Keep the original language of the text. Do not translate. Korrigiere Rechtschreibung und Grammatik und verbessere leicht die Formulierungen für bessere Lesbarkeit. Behalte den Inhalt und den Ton bei. Gib nur den verbesserten Text zurück, ohne Erklärungen:\n\n${text}`,
  3: (text, tov, persona) => `${tov}Keep the original language of the text. Do not translate. Korrigiere Rechtschreibung und Grammatik, verbessere die Formulierungen und passe den Ton und die Sprache an folgende Zielgruppe an: ${persona || 'allgemeine Verbraucher'}. Behalte alle inhaltlichen Informationen bei. Gib nur den angepassten Text zurück, ohne Erklärungen:\n\n${text}`,
